                ...
                <div className="font-mono text-xs sm:text-sm max-h-60 overflow-y-auto scrollbar-hide border border-[#333] bg-black/50">
                  <div className="sticky top-0 z-10 bg-black/90 backdrop-blur-sm border-b border-[#333]">
                    <div className="flex opacity-70 px-3 py-2 text-[#00ff41] text-xs sm:text-sm font-bold">
                      <div className="w-16 sm:w-20 text-left pr-2 sm:pr-3">STATUS</div>
                      <div className="w-32 sm:w-40 text-left pr-2 sm:pr-3">IP</div>
                  ...
                  <div>
                    {connectionLogs.map((log, index) => (
                      <div key={index} className={`flex px-3 py-2 text-xs sm:text-sm ${getLogStatusColor(log)} hover:bg-black/30 transition-colors border-b border-[#333]/20 last:border-b-0`}>
                        <div className="w-16 sm:w-20 font-semibold break-words pr-2 sm:pr-3">{getLogStatusDisplay(log)}</div>
                        <div className="w-32 sm:w-40 text-xs sm:text-sm pr-2 sm:pr-3 whitespace-nowrap overflow-hidden" title={log.ip}>
                          {log.ip}
                        </div>
                        <div className="flex-1 min-w-0 break-words text-xs sm:text-sm leading-tight" title={formatDateTime(log.timestamp)}>
